<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deletestudent.aspx.cs" Inherits="WebApplication1.deletestudent" %>
            ...
            <asp:Panel ID="Panel1" runat="server" Height="693px" Width="917px">
                <div class="style6">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        InsertCommand="INSERT INTO [addstudent] ([REGISTRATION_NO], [STUDENT_NAME], [COURSE], [SEMESTER], [MOBILE_NO], [EMAIL_ID], [SEX], [DOB], [QUALIFICATION], [YEAR_OF_JOINING], [PIN], [STATE], [DISTRICT], [CITY], [GUARDIAN_NAME], [RELIGION], [CASTE]) VALUES (@REGISTRATION_NO, @STUDENT_NAME, @COURSE, @SEMESTER, @MOBILE_NO, @EMAIL_ID, @SEX, @DOB, @QUALIFICATION, @YEAR_OF_JOINING, @PIN, @STATE, @DISTRICT, @CITY, @GUARDIAN_NAME, @RELIGION, @CASTE)" 
                        UpdateCommand="UPDATE [addstudent] SET [STUDENT_NAME] = @STUDENT_NAME, [COURSE] = @COURSE, [SEMESTER] = @SEMESTER, [MOBILE_NO] = @MOBILE_NO, [EMAIL_ID] = @EMAIL_ID, [SEX] = @SEX, [DOB] = @DOB, [QUALIFICATION] = @QUALIFICATION, [YEAR_OF_JOINING] = @YEAR_OF_JOINING, [PIN] = @PIN, [STATE] = @STATE, [DISTRICT] = @DISTRICT, [CITY] = @CITY, [GUARDIAN_NAME] = @GUARDIAN_NAME, [RELIGION] = @RELIGION, [CASTE] = @CASTE WHERE [REGISTRATION_NO] = @REGISTRATION_NO">
                        <DeleteParameters>
                        ...
                        <InsertParameters>
                            ...
                            <asp:Parameter Name="YEAR_OF_JOINING" Type="String" />
