...
<body>
    ...
    <div class="page">
        ...
        <div class="main">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="225px" Width="917px">
                <div class="style6">
                    <br />
                    <br />
                    <asp:Label ID="lab3" runat="server" Font-Bold="True" Font-Names="Algerian" 
                        ForeColor="Red"></asp:Label>
                    <br />
                    <br />
                    <br />
                    <asp:Label ID="lab1" runat="server" Text="USERNAME :" style="color: #000000"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="texu" runat="server"></asp:TextBox>
                    <br />
                    <br />
                    <br />
                    <asp:Label ID="lab2" runat="server" Text="PASSWORD :" style="color: #000000"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="texp" runat="server" TextMode="Password"></asp:TextBox>
                    <br />
                    <br />
                    <br />
                    <asp:Button ID="But1" runat="server" onclick="But1_Click" Text="LOGIN" />
                </div>
            </asp:Panel>
