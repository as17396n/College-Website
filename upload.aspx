...
<body>
    ...
    <div class="page">
        ...
        <div class="main">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="699px" Width="917px">
                <div class="style6">
                    <br />
                    <table class="style8">
                        <tr>
                    ...
                    <br />
                    <br />
                    <asp:Label ID="Label2" runat="server" Font-Names="Algerian" Font-Size="Large" 
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        CaptionAlign="Right" CellPadding="4" DataKeyNames="FILE_ID" 
                        DataSourceID="SqlDataSource1" Border="2"
                        EmptyDataText="There are no data records to display." ForeColor="#333333" 
                        GridLines="None" Height="157px" horizontalalign="Center" 
                        onrowcommand="GridView1_RowCommand" 
                        onselectedindexchanged="GridView1_SelectedIndexChanged" 
                        style="text-align: right" Width="278px">
                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                        <Columns>
                            <asp:BoundField DataField="FILE_ID" HeaderText="FILE_ID" ReadOnly="True" 
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        InsertCommand="INSERT INTO [files] ([FILE_ID], [FILE_NAME]) VALUES (@FILE_ID, @FILE_NAME)" 
                        SelectCommand="SELECT * FROM [files]" 
                        UpdateCommand="UPDATE [files] SET [FILE_NAME] = @FILE_NAME WHERE [FILE_ID] = @FILE_ID">
                        <DeleteParameters>
